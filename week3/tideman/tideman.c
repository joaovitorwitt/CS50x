...
{
    // TODO
    // if name found update ranks array and return true

    // ranks[i] represent the users ith preference
...
{
    // TODO
    // update the global references array
    // preferences[i][j] represent the number of voters who prefer candidate i over j
...
void sort_pairs(void)
{
    ...
    for (int i = 0; i < pair_count; i++)
    {
        ...
        pairs[i] = pairs[max_value];
        pairs[max_value] = temporary;
    }
